...
public interface INetwork {
   ...
   *           if neither node is in this network.
   * @throws IllegalStateException
   *           if this is called while the network is already updating, for
   *           example from {@link INetworkNode#receive} (which may be called
   *           during the update).
   */
   ...
   * 
   * @param node
   *          the node to remove from the network.
