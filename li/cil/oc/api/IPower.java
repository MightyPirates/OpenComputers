...
public interface IPower {
   ...
   * power as is required for this tick. The component returns how much power it
   * could actually generate. The component should always consume its fuel. If
   * there is not enough power to keep the computer running, fuel will go to
   * waste. This is by design.
   * 
   * @param amount
   *          the power required to keep the computer running.
   * @return the amount of power this component could generate.
   */
  double consumePower(double amount);
}