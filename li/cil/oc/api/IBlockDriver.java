...
public interface IBlockDriver extends IDriver {
   ...
   * It is also passed to the {@link IDriver#close} method.
   * 
   * @param world
   *          the world in which the block to get the component for lives.
   * @param x
   *          the X coordinate of the block to get the component for.
   * @param y
   *          the Y coordinate of the block to get the component for.
   * @param z
   *          the Z coordinate of the block to get the component for.
   * @return the block component at that location, controlled by this driver.
   */
  Object getComponent(World world, int x, int y, int z);
}