...
class GuiRobot(playerInventory: InventoryPlayer, val robot: tileentity.Robot) extends DynamicGuiContainer(new container.ContainerRobot(playerInventory, robot)) with traits.InputBuffer {
