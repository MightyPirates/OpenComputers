...
class GuiAssembler(playerInventory: InventoryPlayer, val assembler: tileentity.TileEntityAssembler) extends DynamicGuiContainer(new container.ContainerAssembler(playerInventory, assembler)) {
  xSize = 176
  ySize = 192
