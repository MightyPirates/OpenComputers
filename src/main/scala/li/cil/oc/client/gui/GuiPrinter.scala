...
class GuiPrinter(playerInventory: InventoryPlayer, val printer: tileentity.Printer) extends DynamicGuiContainer(new container.ContainerPrinter(playerInventory, printer)) {
  xSize = 176
  ySize = 166
