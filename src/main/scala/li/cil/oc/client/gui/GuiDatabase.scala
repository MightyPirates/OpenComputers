...
class GuiDatabase(playerInventory: InventoryPlayer, val databaseInventory: DatabaseInventory) extends DynamicGuiContainer(new container.ContainerDatabase(playerInventory, databaseInventory)) with traits.LockedHotbar {
  ySize = 256
