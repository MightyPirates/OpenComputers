...
class ContainerAssembler(playerInventory: InventoryPlayer, val assembler: tileentity.TileEntityAssembler) extends AbstractContainerPlayer(playerInventory, assembler) {
  // Computer case.
  {
