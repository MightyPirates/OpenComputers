...
class RobotAssembler(val parent: SimpleDelegator) extends SimpleDelegate {
  ...
  override def registerIcons(iconRegister: IconRegister) = {
    ...
    icons(ForgeDirection.SOUTH.ordinal) = iconRegister.registerIcon(Settings.resourceDomain + ":assembler_front")
