...
public final class Settings {
    public static Settings get() {return null;}
    ...
    public double constantXpGrowth;
    public double exponentialXpGrowth;
    public double robotActionXp;
    public double robotExhaustionXpRate;
    public double robotOreXpRate;
    ...
    public double placeDelay;
    public double dropDelay;
    public double suckDelay;
    ...
    lazy val
    ignorePower =pureIgnorePower ||(!is3rdPartyPowerSystemPresent &&!Mods.isPowerProvidingModPresent)
    ...
    // power.buffer
    public double bufferCapacitor;
    public double bufferCapacitorAdjacencyBonus;
    public double bufferComputer;
    public double bufferRobot;
    public double bufferConverter;
    public double bufferDistributor;
    public double[] bufferCapacitorUpgrades;
    public double bufferTablet;
    public double bufferAccessPoint;
    public double bufferDrone;
    public double bufferMicrocontroller;
    public double bufferHoverBoots;
    public double bufferNanomachines;

    // power.cost
    public double computerCost;
    public double microcontrollerCost;
    public double robotCost;
    public double droneCost;
    public double sleepCostFactor;
    public double screenCost;
    public double hologramCost;
    public double hddReadCost;
    public double hddWriteCost;
    public double gpuSetCost;
    public double gpuFillCost;
    public double gpuClearCost;
    public double gpuCopyCost;
    public double robotTurnCost;
    public double robotMoveCost;
    public double robotExhaustionCost;
    public double wirelessCostPerRange;
    public double abstractBusPacketCost;
    public double geolyzerScanCost;
    ...
    public double chunkloaderCost;
    public double pistonCost;
    public double eepromWriteCost;
    ...
    public double transposerCost;
    public double nanomachineCost;
    public double nanomachineReconfigureCost;
    public double mfuCost;

    // power.rate
    public double accessPointRate;
    public double assemblerRate;
    public double[] caseRate;
    // Creative case.
    public double chargerRate;
    public double disassemblerRate;
    public double powerConverterRate;
    public double serverRackRate;

    // power.value
    private double valueAppliedEnergistics2;
    private double valueFactorization;
    private double valueGalacticraft;
    private double valueIndustrialCraft2;
    private double valueMekanism;
    private double valuePowerAdvantage;
    private double valueRedstoneFlux;
    private double valueRotaryCraft;

    private double valueInternal = 1000;

    public double ratioAppliedEnergistics2 = valueAppliedEnergistics2 / valueInternal;
    public double ratioFactorization = valueFactorization / valueInternal;
    public double ratioGalacticraft = valueGalacticraft / valueInternal;
    public double ratioIndustrialCraft2 = valueIndustrialCraft2 / valueInternal;
    public double ratioMekanism = valueMekanism / valueInternal;
    public double ratioPowerAdvantage = valuePowerAdvantage / valueInternal;
    public double ratioRedstoneFlux = valueRedstoneFlux / valueInternal;
    public double ratioRotaryCraft = valueRotaryCraft / valueInternal;
    ...
    public boolean httpHeadersEnabled;
    public boolean tcpEnabled;
    public String[] httpHostBlacklist;
    public String[] httpHostWhitelist;
    ...
    // ----------------------------------------------------------------------- //
    // switch
    public int switchDefaultMaxQueueSize;
    public int switchQueueSizeUpgrade;
    public int switchDefaultRelayDelay;
    public double switchRelayDelayUpgrade;
    public int switchDefaultRelayAmount;
    public int switchRelayAmountUpgrade;

    // ----------------------------------------------------------------------- //
    // hologram
    public double[] hologramMaxScaleByTier;
    public double hologramMaxTranslationByTier;
    public double hologramSetRawDelay;
    public boolean hologramLight;
    ...
    public int[] databaseEntriesPerTier;
    ...
    public int serverRackSwitchTier;
    ...
    // ----------------------------------------------------------------------- //
    // nanomachines
    public double nanomachineTriggerQuota;
    public double nanomachineConnectorQuota;
    public int nanomachineMaxInputs;
    public int nanomachineMaxOutputs;
    public int nanomachinesSafeInputsActive;
    public int nanomachinesMaxInputsActive;
    public double nanomachinesCommandDelay;
    public double nanomachinesCommandRange;
    public double nanomachineMagnetRange;
    public int nanomachineDisintegrationRange;
    public String[] nanomachinePotionWhitelist;
    public double nanomachinesHungryDamage;
    public double nanomachinesHungryEnergyRestored;
    ...
    public double costProgrammingTable;
    ...
    public boolean forceCaseInsensitive;
    public boolean logFullLibLoadErrors;
    public boolean forceNativeLib;
