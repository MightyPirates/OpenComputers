...
/**
 * This interface can be used with an {@link NodeContainer}
 ...
 */
public interface ManagedPeripheral extends NodeContainer {
    /**
     ...
     *                                         specified name.
     */
    Object[] invoke(final String method, final Context context, final Arguments args) throws Exception;
}
